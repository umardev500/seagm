...
export const SearchForm: React.FC = () => {
  ...
  return (
    <div tabIndex={0} onFocus={handleFocus} onBlur={handleBlur} ref={containerRef} className="search-form border border-gray-100 flex items-center rounded-full pr-3">
